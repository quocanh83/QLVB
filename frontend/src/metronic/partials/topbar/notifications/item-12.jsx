        ...
        <Card className="shadow-none flex flex-col gap-2.5 p-3.5 rounded-lg">
          ...
          <div className="flex items-center gap-2.5">
            <Badge
              ...
              variant="primary"
              appearance="light"
              className="text-primary me-1 text-sm flex items-center gap-1"
            >
              <KeenIcon icon="messages" className="text-sm" /> 26 Comments
            </Badge>
            <Badge
              size="sm"
              variant="outline"
              className="text-muted-foreground me-1 text-sm flex items-center gap-1"
            >
              <KeenIcon icon="heart" className="text-sm" /> 13 Likes
            </Badge>
          </div>
        </Card>
      </div>
