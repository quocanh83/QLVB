...
export function SearchDialog({ trigger }) {
  ...
  const mixedSettingsItems = [
    { icon: 'address-book', info: 'Public Profile' },
    { icon: 'setting-2', info: 'My Account' },
    { icon: 'code', info: 'Devs Forum' },
  ];
  ...
  const settingsItems = [
    {
      ...
      children: [
        ...
        { icon: 'award', info: 'Public Profile' },
    ...
    },
    {
      title: 'Actions',
      children: [
        { icon: 'plus-square', info: 'Create User' },
        { icon: 'user-edit', info: 'Create Team' },
        { icon: 'text-align-left', info: 'Change Plan' },
        { icon: 'setting-3', info: 'Setup Branding' },
      ],
    },
  ];
      ...
      <DialogContent className="lg:max-w-[600px] lg:top-[15%] lg:translate-y-0 p-0 [&_[data-slot=dialog-close]]:top-5.5 [&_[data-slot=dialog-close]]:end-5.5">
        <DialogHeader className="px-4 py-1 mb-1">
          ...
          <div className="relative">
            <KeenIcon icon="magnifier" className="absolute top-1/2 -translate-y-1/2 size-4" />
            <Input
              type="text"
              name="query"
              value={searchInput}
